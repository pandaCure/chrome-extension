...
const getWebpackBaseConfig = ({ isNoExtractCss }) => ({
  ...
  resolve: {
    ...
    alias: {
      ...
      '@devtools-src': path.resolve(__dirname, 'devtools-src'),
      '@devtools-components': path.resolve(__dirname, 'devtools-src/components'),
      '@sidebar-src': path.resolve(__dirname, 'sidebar-src'),
      '@sidebar-components': path.resolve(__dirname, 'sidebar-src/components'),
    },
  },
  //
  module: {
